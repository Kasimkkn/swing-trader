...
import { Loader2, TrendingUp, TrendingDown, Activity, Globe, Calendar, Users, BarChart3, Search } from 'lucide-react';
      ...
      <main className="px-4 py-6">
        ...
        <div className="flex flex-col items-center justify-center mb-8">
          ...
          {currentSymbol && (
            <Button
              variant="outline"
              onClick={() => handleResearch(currentSymbol)}
              disabled={isResearching}
              className="flex items-center gap-2 border-white/30 bg-white/5 hover:bg-white/10 text-sm md:text-base"
            >
              {isResearching ? (
                <>
